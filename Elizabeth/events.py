...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Elizabeth.events

        path = Path(f"Elizabeth/modules/{shortname}.py")
        name = "Elizabeth.modules.{}".format(shortname)
